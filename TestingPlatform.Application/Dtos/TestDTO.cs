...
public class TestDto
{
    ...
    public List<QuestionDto> Questions { get; set; } // Список вопросов в тесте
    public List<StudentDto> Students { get; set; } // Список студентов, для которых доступен тест
    public List<ProjectDto> Projects { get; set; } // Список проектов, для которых доступен тест
    public List<CourseDto> Courses { get; set; } // Список курсов, для которых доступен тест
    public List<GroupDto> Groups { get; set; } // Список групп, для которых доступен тест
    public List<DirectionDto> Directions { get; set; } // Список направлений, для которых доступен тест
