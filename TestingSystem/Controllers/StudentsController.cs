...
//    {
//        var emailExists = _db.Students.Where(s => s.User.Email ==
//        student.User.Email).ToList();
//        if (emailExists.Any())
...
//    {
//        var exists = _db.Students.FirstOrDefault(s => s.Id ==
//        student.Id);
//        if (exists == default)
//            return NotFound();
//        var emailInUse = _db.Students.Any(s => s.User.Email ==
//        student.User.Email && s.Id != student.Id);
//        if (emailInUse)
//            return Conflict("Такой email уже используется"); // 409
