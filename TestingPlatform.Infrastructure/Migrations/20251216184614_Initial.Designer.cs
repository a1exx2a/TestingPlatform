...
namespace TestingPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20251216184614_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseTest", b =>
                {
                    ...
                    b.ToTable("test_course", (string)null);
                });
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.Student", b =>
                {
                    ...
                    b.HasOne("TestingPlatform.Domain.Models.Users", "User")
                        .WithOne("Student")
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.Test", b =>
                {
                    b.HasOne("TestingPlatform.Domain.Models.TestResult", "TestResult")
                        .WithOne("Test")
                        .HasForeignKey("TestingPlatform.Domain.Models.Test", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
